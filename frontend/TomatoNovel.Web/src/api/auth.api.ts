...
} from '@/types/auth/requests/login-or-register-request.types'

import type {
  LoginOrRegisterResponse
} from '@/types/auth/responses/login-or-register-response.types'
...
export const loginByPassword = (data: LoginOrRegisterRequest) => {
  return request.post<LoginOrRegisterResponse>(
    '/auth/login_or_register/pwd',
    data
  )
}
